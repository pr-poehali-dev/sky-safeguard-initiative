      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex-1 max-w-lg mt-8">
            ...
            >
              Игрушки с историей и теплом.
            </h2>

            <div className="space-y-4 text-foreground">
              <div className="flex items-start gap-3">
                <span className="text-accent mt-1">*</span>
                <p className="text-sm">Каждая игрушка в нашем музее — живой след мастерства и народных традиций.</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-accent mt-1">*</span>
                <p className="text-sm">Мы сохраняем ремесло, вдохновляем детей и взрослых, делимся любовью к дереву.</p>
              </div>
            </div>
          </div>
        ...
        <div id="contact" className="w-full px-6 py-16 flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 md:gap-0 border-t border-border mt-16">
          <div className="flex flex-col md:flex-row gap-2 text-center md:text-left">
            <h2 className="text-foreground font-mono text-xl font-bold">Добро пожаловать в музей!</h2>
            <p className="text-foreground font-mono font-normal text-base">Деревянные игрушки — живая история</p>
          </div>
        ...
        <div className="w-full px-6 py-4 border-t border-border flex md:flex-row items-center justify-between gap-2 flex-row">
          <p className="text-muted-foreground text-sm font-mono">2025 Музей деревянных игрушек</p>
